 ...
 * service is started.
 */
public abstract class Flic2HeadlessJsTaskService extends Service implements HeadlessJsTaskEventListener {
    ...
    if (sWakeLock == null || !sWakeLock.isHeld()) {
      ...
      sWakeLock =
        powerManager.newWakeLock(
          PowerManager.PARTIAL_WAKE_LOCK, Flic2HeadlessJsTaskService.class.getCanonicalName());
